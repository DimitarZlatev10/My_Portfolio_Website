        ...
        <div class="text-center flex flex-col md:flex-row justify-evenly items-center">
            ...
            <div class="flex justify-center mt-2">
                <NuxtLink aria-label="Visit Dimitar Zlatev's GitHub profile" target="_blank"
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" class="mr-2 hover:opacity-55 cursor-pointer" width="32"
                        height="32" viewBox="0 0 256 250">
                        <path fill="white"
                ...
                <NuxtLink aria-label="Visit Dimitar Zlatev's LinkedIn profile" target="_blank"
