...
<template>
    <div class="min-h-screen flex items-center justify-center bg-gradient-to-r from-blue-700 to-purple-700 text-white">
        <div class="container mx-auto px-6 py-16">
            <div class="flex flex-col md:flex-row items-center">
                <div class="md:w-1/2 text-center md:pr-12 animate-fade-in">
                    <h1 class="text-5xl md:text-7xl font-bold mb-4">
                        Hi, my name is <span class="text-yellow-500">Dimitar Zlatev</span>
                    </h1>
                    <p class="text-2xl md:text-3xl font-light">
                        I'm a <span class="text-yellow-500">full stack developer</span>
                    </p>
                    <div class="mt-8">
                        <ul class="space-y-4 text-center">
                            <li class="pb-3" v-for="link in links" :key="link.name">
                                <NuxtLink
                                    class="px-6 py-3 bg-yellow-500 text-blue-900 font-semibold rounded-full hover:bg-yellow-600 transition duration-300"
                                    :to="link.link">
                                    {{ link.name }}
                                </NuxtLink>
                            </li>
                    ...
                    <div class="flex justify-center mt-4">
                        <NuxtLink target="_blank" to="https://github.com/DimitarZlatev10"
                            aria-label="Visit Dimitar Zlatev's GitHub profile">
                            <svg xmlns="http://www.w3.org/2000/svg" class="mr-2 hover:opacity-55 cursor-pointer"
                                width="32" height="32" viewBox="0 0 256 250">
                                <path fill="#161614"
                        ...
                        <NuxtLink target="_blank" to="https://www.linkedin.com/in/dimitar-zlatev-65b14225b/"
                            aria-label="Visit Dimitar Zlatev's LinkedIn profile">
                            <svg xmlns="http://www.w3.org/2000/svg" class="hover:opacity-55 cursor-pointer" width="32"
