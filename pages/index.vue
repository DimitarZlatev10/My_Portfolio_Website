            ...
            <div class="flex flex-col md:flex-row items-center">
                <div class="md:w-1/2 text-center md:pr-12 animate-fade-in">
                    <h1 class="text-5xl md:text-7xl font-bold mb-4">
                        Hi, my name is <span class="text-yellow-300">Dimitar Zlatev</span>
                    </h1>
                    <p class="text-2xl md:text-3xl font-light">
                        I'm a <span class="text-yellow-300">full stack developer</span>
                    </p>
                    <div class="mt-8">
                ...
                <div class="md:w-1/2 mt-8 md:mt-0 flex justify-center animate-fade-in animation-delay-1">
                    <img src="https://via.placeholder.com/400" alt="Example Image"
