    ...
    <div class="bg-gradient-to-r from-blue-500 via-pink-500 to-purple-500 min-h-screen">
        <div class="container mx-auto p-6">
            <div class="space-y-12 animate-fade-in animation-delay-1">
                ...
                <div>
                    <h2 class="text-3xl font-semibold mb-4 text-yellow-300">Front-end Skills</h2>
                    <ul class="list-disc list-inside space-y-2 pl-4 font-bold">
                        <li class="text-lg flex justify-center items-center cursor-pointer">
                            <p class="mr-2">Tailwind CSS</p>
                            <svg xmlns="http://www.w3.org/2000/svg" width="50" height="32" viewBox="0 0 256 154">
                                <defs>
                        ...
                        <li class="text-lg flex justify-center items-center cursor-pointer">
                            <p class="mr-2">JavaScript</p>
                            <svg xmlns="http://www.w3.org/2000/svg" width="50" height="32" viewBox="0 0 256 256">
                        ...
                        <li class="text-lg flex justify-center items-center cursor-pointer">
                            <p class="mr-2">Nuxt.js</p>
                            <svg xmlns="http://www.w3.org/2000/svg" width="50" height="32" viewBox="0 0 256 168">
                                <path fill="#00DC82"
                        ...
                        <li class="text-lg flex justify-center items-center cursor-pointer">
                            <p class="mr-2">Livewire</p>
                            <svg xmlns="http://www.w3.org/2000/svg" width="50" height="32" viewBox="0 0 128 128">
                        ...
                        <li class="text-lg flex justify-center items-center cursor-pointer">
                            <p class="mr-2">HTML</p>
                            <svg xmlns="http://www.w3.org/2000/svg" width="50" height="32" viewBox="0 0 256 361">
                                <path fill="#E44D26"
                ...
                <div>
                    <h2 class="text-3xl font-semibold mb-4 text-yellow-300">Back-end Skills</h2>
                    <ul class="list-disc list-inside space-y-2 pl-4 font-bold">
                        <li class="text-lg flex justify-center items-center cursor-pointer">
                            <p class="mr-2">Express.js</p>
                            <svg xmlns="http://www.w3.org/2000/svg" width="50" height="32" viewBox="0 0 128 128">
                                <path
                        ...
                        <li class="text-lg flex justify-center items-center cursor-pointer">
                            <p class="mr-2">Node.js</p>
                            <svg xmlns="http://www.w3.org/2000/svg" width="50" height="32" viewBox="0 0 256 289">
                                <path fill="#539E43"
                        ...
                        <li class="text-lg flex justify-center items-center cursor-pointer">
                            <p class="mr-2">Laravel</p>
                            <svg xmlns="http://www.w3.org/2000/svg" width="50" height="32" viewBox="0 0 256 264">
                                <path fill="#FF2D20"
                        ...
                        <li class="text-lg flex justify-center items-center cursor-pointer">
                            <p class="mr-2">MySQL</p>
                            <svg xmlns="http://www.w3.org/2000/svg" width="50" height="32" viewBox="0 0 256 252">
                                <path fill="white"
                ...
                <div>
                    <h2 class="text-3xl font-semibold mb-4 text-yellow-300">Other Skills</h2>
                    <ul class="list-disc list-inside space-y-2 pl-4 font-bold">
                        <li class="text-lg flex justify-center items-center cursor-pointer">
                            <p class="mr-2">Git</p>
                        ...
                        <li class="text-lg flex justify-center items-center cursor-pointer">
                            <p class="mr-2">Langchain</p>
                        </li>
                        <li class="text-lg flex justify-center items-center cursor-pointer">
                            <p class="mr-2">GraphQL</p>
                        </li>
                    </ul>
                </div>
            </div>
